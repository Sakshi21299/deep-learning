# -*- coding: utf-8 -*-
"""
Created on Wed Apr 24 10:40:40 2024
...
def simple_nn_baseline(hidden_layers, learning_rate):
    ...
    #Append output from NN1 to the feature tensor
    ...
    torch.save(model.state_dict(), 'nn_target_2_model_pca_with_pred1.pkl') # Save the model
    plt.figure()
