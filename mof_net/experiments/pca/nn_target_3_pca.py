...
def simple_nn_baseline(hidden_layers, learning_rate):
    ...
    # model_target1.load_state_dict(torch.load(r"C:\Users\ssnaik\Documents\Courses\Homeworks\adv_deep_learning\Project\deep-learning\mof_net\experiments\saved_models\pca_models\nn_target_1_model_11_pca_150_200_001.pkl"))
    ...
    # #Do pca for second target with the appended feature tensor
    # features_target2 = get_principal_components(features_tensor, 16)
    
    # #Data for loading model outputs from first target network
    # input_size_t2 = features_target2.shape[1]  
    # output_size_t2 = targets_tensor[:,1:2].shape[1]  
    # hidden_t2 = [250, 200]
    
    # #load model for secon target
    # model_target2 = SimpleNN(input_size_t2, hidden_t2, output_size_t2)
    # model_target2.load_state_dict(torch.load(r"C:\Users\ssnaik\Documents\Courses\Homeworks\adv_deep_learning\Project\deep-learning\mof_net\experiments\saved_models\pca_models\nn_target_2_model_16_pca_250_200_01.pkl"))
    
    # #Evaluate target 2 by passing the features through trained model
   
    # with torch.no_grad():
    #     outputs = model_target2(features_target2)
