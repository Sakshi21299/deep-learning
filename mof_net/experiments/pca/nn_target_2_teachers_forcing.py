# -*- coding: utf-8 -*-
"""
Created on Wed Apr 24 14:08:31 2024
...
def simple_nn_baseline(hidden_layers, learning_rate):
    ...
    features_tensor_test = get_principal_components(features_tensor_test, 10)
    ...
    torch.save(model.state_dict(), 'nn_target_2_model_pca_teachersforcing.pkl') # Save the model
    plt.figure()
