# -*- coding: utf-8 -*-
"""
Created on Tue Apr 23 22:23:13 2024
...
def append_feature_vector(features_target1, targets_tensor):
...
def simple_nn_baseline(hidden_layers, learning_rate):
    ...
    #Append outputs from target 1
    features_tensor = append_feature_vector(features_tensor, targets_tensor)
    ...
    torch.save(model.state_dict(), 'nn_target_2_model_50_70_001_mse.pkl') # Save the model
    plt.figure()
